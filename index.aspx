...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  <div class="maincontainer"> 
    ...
    <section class="container_sec">
      <p class="pdt20"> YES SECURITIES, a wholly-owned subsidiary of YES BANK, is one of the leading financial advisors in India, offering a gamut of services such as Investment Banking, Merchant Banking, Institutional and Equity Research, Institutional Sales, Portfolio Investment Advisory and Broking services. The firm has a robust track record of completing over 300 successful Investment Banking and Merchant Banking deals. YES SECURITIES is registered under Securities and Exchange Board of India (SEBI), National Stock Exchange (NSE), Bombay Stock Exchange (BSE), Multi Commodity Exchange (MCX) and National Commodity & Derivatives Exchange (NCDEX).
	  </p>
     </section>
      <!--1 main end -->
        ...
        <h1 class="main_hd text-center">Our Services</h1>
          <div class="row mrt40">
            ...
            <div class="col-sm-12 col-md-6 mob_pdb40">
              <div class="card"> <img class="card-img-top img-responsive" src="images/investment-banking.jpg">
                <div class="card-body">
             ...
             <!-- 2 start -->
            <div class="col-sm-12 col-md-6 mob_pdb40">
              <div class="card"> <img class="card-img-top img-responsive" src="images/merchant-banking.jpg">
                <div class="card-body">
      ...
      <div class="row">
        <div class="slider">
          <div id="expertise_slider" class="flexslider carousel">
            <ul class="slides">
              <li class="col-sm-3"> <img src="images/health-care-icon.svg" class="img-centered" />
                <div class="list_title text-center">Renewable <br>
					&amp; Healthcare</div>
              </li>
              <li class="col-sm-3"> <img src="images/infrastructure-icon.svg" class="img-centered" />
                <div class="list_title text-center">Infrastructure <br>
                  &amp; Logistics</div>
              </li>
              <li class="col-sm-3"> <img src="images/telecom-icon.svg" class="img-centered" />
                <div class="list_title text-center">Technology, Media <br>
                  &amp; Telecommunications</div>
              </li>
              <li class="col-sm-3"> <img src="images/food-icon.svg" class="img-centered" />
                <div class="list_title text-center">Food &amp; Agriculture,<br>
                  Life Sciences</div>
              </li>
              <li class="col-sm-3"> <img src="images/health-care-icon.svg" class="img-centered" />
                <div class="list_title text-center">Renewable <br>
      ...
      <div class="testimonials_carousel_sec">
        <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
          ...
          <div class="carousel-inner">
            <div class="item">
              <div class="testimonials_chat_box"> <span class="left_quote">"</span><span class="right_quote">"</span>
              ...
              <div class="testimonials_img_cont">
                <div class="testimonials_img"><img src="images/testimonials_img01.png" class="img-circle"></div>
                <div class="testimonials_cont">Lorem Ipsum<br>
                  em ipsum dolor sit amet</div>
              </div>
            </div>
            <div class="item">
              <div class="testimonials_chat_box"> <span class="left_quote">"</span><span class="right_quote">"</span>
